...
# Start to enroll some user, ensure the machine to be at the registration
# user condition
CMD_STARTENROLL = 61
# Make the machine to be at the waiting order status, please refers to the
# CMD_STARTENROLL description.
...
# Make the machine to be at the shut-down condition, generally
# demonstrates ‘in the work ...’on LCD
...
# be real–time to press fingerprint (be real time to return data type sign)
EF_FINGER = (1 << 1)
