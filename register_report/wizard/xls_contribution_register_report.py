...
class register_report_xls(models.AbstractModel):
    _name = 'report.register_report.register_report_xls'
...
#             ws.write(row,col+8,empty_string_if_none(obj.branch_id.name),cell_format)
            ws.write(row,col+8,obj.payslip_name,cell_format)
            ws.write(row,col+9,obj.wage,cell_format)
            ws.write(row,col+10,obj.amt,cell_format)
            ws.write(row,col+11,obj.rate,cell_format)
            ws.write(row,col+12,obj.total,cell_format)
